...
@Autonomous
public class AutonomousLeave extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        flTarget = (int)(-750 * COUNTS_PER_MM);
        blTarget = (int)(750 * COUNTS_PER_MM);
        frTarget = (int)(750 * COUNTS_PER_MM);
        brTarget = (int)(-750 * COUNTS_PER_MM);
